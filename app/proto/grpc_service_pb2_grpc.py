...
class StoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateStory = channel.unary_unary(
                ...
                request_serializer=grpc__service__pb2.StoryRequest.SerializeToString,
                response_deserializer=grpc__service__pb2.StoryResponse.FromString,
...
def add_StoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateStory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=grpc__service__pb2.StoryRequest.FromString,
                    response_serializer=grpc__service__pb2.StoryResponse.SerializeToString,
            ),
    }
...
class StoryService(object):
    ...
    def GenerateStory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/story.StoryService/GenerateStory',
            grpc__service__pb2.StoryRequest.SerializeToString,
            grpc__service__pb2.StoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
